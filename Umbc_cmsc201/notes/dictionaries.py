...
pyopoly_map["lincoln woods"]=  {'value': 28, 'color': "rainbow"}

for property in pyopoly_map:
    print(property, pyopoly_map[property]['value'],"and favorite color is", pyopoly_map[property]['color'] )
...
list = []
dictionary = {1: "hello", 2: "goodbye", 3: "bye"}

for stuff in dictionary:
    list.append(dictionary[stuff])
